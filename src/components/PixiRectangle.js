...
export default class PixiRectangle extends PixiComponent {
  drawRectangle() {
    this._renderer.lineStyle(0, this.props.borderColor === undefined ? 0xffffff : this.props.borderColor, 1);
    this._renderer.beginFill(this.props.fillColor === undefined ? 0xffffff : this.props.fillColor, this.props.alpha || 1);
